...
RC readBlock(int pageNum, SM_FileHandle *fHandle, SM_PageHandle memPage)
{
	...
	else
	{
		...
		//FP NULL check added by karthiK
		//startPosition == (pageNum * PageSize) + (2*PageSize)
		//endPostion == startPosition + PageSize.

		//below Logic changed by karthik to fit in the needs of metaData.
		if (fp != NULL)
		{
